...
namespace Libreria.AccesoBD
{
    public class CrudRestaurantePlatos
    {
        ...
        public bool CrearRestaurantePlato(RestaurantePlato restPlato)
        {
            ...
            string sentenciaSQL = "INSERT INTO dbo.PlatoRestaurante (IdAsignacion, IdRestaurante, IdPlato, FechaAsignacion)" +
            ...
            using (conexion = new(cadenaConexion))
            {
                try
                {
                    ...
                    //Parámetros
                    cmd.Parameters.AddWithValue("@IdAsignacion", restPlato.Id);
